...
use frontend_forge_common::{
    ...
    ANNO_FE_OBSERVED_GENERATION, ANNO_PUBLISH_ARTIFACT_DIGEST, ANNO_PUBLISH_REQUEST_GENERATION,
    ...
    FE_PUBLISH_STATUS_PUBLISHING, LABEL_ARTIFACT_KEY_SHORT, LABEL_FE_BUILD_KIND,
    LABEL_FE_MANAGED_BY, LABEL_FE_NAME, LABEL_FE_PACKAGE_STATUS, LABEL_FE_PUBLISH_FRESH,
    LABEL_FE_PUBLISH_STATUS, LABEL_FE_UID, LABEL_PACKAGE_KIND, LABEL_PUBLISH_KIND,
